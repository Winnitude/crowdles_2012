class PlatformLocalAdmin
  ...
  def self.create_main_local_admin user ,param
    ...
    general_setting = local_admin.build_la_general_setting(:language => param[:language] ,:la_country => param[:platform_master_country]).save
  ...
  def self.create_all_local_admins param
     ...
     all_countries.each do |i|
       ...
       general_setting = local_admin.build_la_general_setting(:language => param[:language] ,:la_country => i.country_english_name).save
